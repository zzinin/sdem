	...
	@Test
	 ...
	 //   	String checkIn= bc.makeDate(10);
	  ...
	  //  	hp.Datepicker1("July 2026", "05");
	    	...
	    	Thread.sleep(3000);
	    	hp.doReservation();
	    	hp.setFirstName(p.getProperty("nfirstname"));
	    	hp.setLastName(p.getProperty("nlastname"));
	    	hp.Email(p.getProperty("nemail"));
	    	hp.Phone(p.getProperty("nphone"));
	   ...
	   // 	hp.doReservation();
	    	...
	    	if (driver.findElement(By.xpath("//*[@id=\"root-container\"]/div/div[2]/div/div[2]/div/div/form/div[5]")).isDisplayed()) {
